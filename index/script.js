...
botonCrear.addEventListener("click", () => {
  ...
  if (
    ...
    tabla.innerHTML += `<tr><th scope="row">${Nombre}</th><td>${Apellido}</td><td>${Nit}</td><td>${Direccion}</td><td>${Ciudad}</td><td>${Telefono}</td><td>${CD}</td><td>Activado</td><td>
    ...
    //   let NombreEli = document.getElementById(`.fila-${eliminar}`);
    //   NombreEli.remove();
    // });

    // const buscar = document.getElementById("buscar");
    // const valorBuscar = document.getElementById("valor");

    // valorBuscar.addEventListener("click", () => {
    //   console.log("a");
    // });
